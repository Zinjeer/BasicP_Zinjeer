...
def main():
    ...
    movies = [
        ...
        {'movie_name': 'The Notebook', 'genre': 'Romantic', 'ticket_price': 200, 'age_restriction': '13'},
    ...
    # ELSE 2
    show_movies(movies) 
    movie_pick = int(input("เลือกหนังตามหมายเลข1-5"))
    picked = movies[movie_pick]
    print(picked['age_restriction'])
    # age input
    user_age = input("กรอกอายุ")
    check_age(user_age, picked)
